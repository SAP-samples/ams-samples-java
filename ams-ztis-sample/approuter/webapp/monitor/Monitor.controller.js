        ...
        return Controller.extend("monitor.monitor.monitor.Monitor", {
            onInit: function () {
                this.getView().setModel(new JSONModel([
                    ...
                    {
                        title: "/ams-jakarta-app/certificate",
                        text: "GET /certificate returns details about the X.509 certificate used by the application, including the certificate itself and its subjectAlternativeNames if available.",
                    },
                    {
                        title: "/ams-jakarta-app/svid",
                        text: "GET /svid returns information about the certificate chain and trust bundle used by the application, including the certificates themselves, their subjectAlternativeNames (if available), and the trust bundle for the trust domain.",
                    },
                    {
