...
public class CallbackServlet extends HttpServlet {
    ...
    private String generateUrlForSubscriber(HttpServletRequest request) throws IOException {
        ...
        String appRouterSuffix = request.getServerName().replaceFirst("^[^.]+", System.getenv("SUBSCRIPTION_SUFFIX"));
        ...
        String url = String.format("https://%s%s", subscriber.get("subaccountSubdomain"), appRouterSuffix);
