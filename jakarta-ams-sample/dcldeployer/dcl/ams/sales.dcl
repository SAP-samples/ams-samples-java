...
POLICY readAllSales_Europe {
  USE readAllSalesOrders RESTRICT Country IN ('AT', 'BE', 'BG', 'HR', 'CY', 'DK', 'EE', 'FI', 'FR', 'DE',
...
TEST readAllSales_EuropeTest {
  ...
  GRANT read on salesOrders POLICY readAllSales_Europe INPUT { Country: 'LV' };
  DENY write on salesOrders POLICY readAllSales_Europe INPUT { Country: 'LV' };
  DENY read on salesOrders POLICY readAllSales_Europe INPUT { Country: 'US' };
}
